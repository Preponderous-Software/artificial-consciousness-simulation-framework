...
Vendored into artificial-consciousness-simulation-framework unmodified apart from this
note. No direct theory mapping - infrastructure module (see interfaces/usage_reporting.py).
"""
